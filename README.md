# Budget Tracker Plugin for Jira
...
1. Download the latest version of the Budget Tracker plugin JAR file from the [releases page](https://github.com/moeeztaher/Budget-Tracker-Jira-Plugin/releases).
